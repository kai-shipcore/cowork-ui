    ...
    <section className="parts-workspace">
      ...
      <Card>
        ...
        >
          ...
          <TabsContent value="parts" className="grid-tab-content">
            <SeatCoverPartPanel
              query={partQuery}
              onQueryChange={setPartQuery}
            />
          </TabsContent>
          <TabsContent value="codes" className="grid-tab-content">
            <SeatCoverCodePanel
              query={codeQuery}
              onQueryChange={setCodeQuery}
            />
          </TabsContent>
          <TabsContent value="library" className="grid-tab-content">
            {message && (
                ...
                <div className="parts-diagram-panel">
                  <div className="parts-section-heading">
                    ...
                    <div>
                      ...
                      <p>
                        Select a row and area to filter available part types.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="parts-workflow-note">
                    ...
                    <p>
                      Link shared parts in each project by selecting the
                      required <strong>revision and quantity</strong>for that
                      project.
                    </p>
                  </div>
                </div>
