import{j as t,aL as i,aM as d}from"./index-B0zikW6u.js";var o=d(`
  ...
  `,{variants:{variant:{sm:"px-2.5 py-2.5 text-xs rounded-md",md:"px-3 py-3 text-[0.8125rem] leading-(--text-sm--line-height) rounded-md",lg:"px-4 py-4 text-sm rounded-md"}},defaultVariants:{variant:"md"}});function s({className:r,variant:a,...e}){return t.jsx("textarea",{"data-slot":"textarea",className:i(o({variant:a}),r),...e})}export{s as T};
